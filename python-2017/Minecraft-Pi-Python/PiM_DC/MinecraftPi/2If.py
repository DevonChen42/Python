...
def chest(mc,x,y,z):
	...
	mc.setBlocks(x+2,y+3,z+7,x+4,y,z,woodp)
	mc.setBlocks(x+2,y+3,z+6,x+4,y,z,air)
	mc.setBlocks(x+5,y+3,z+7,x,y,z,wood)
	mc.setBlocks(x+5,y+3,z+6,x,y,z,woodp)
	mc.setBlocks(x+5,y+3,z,x,y,z,wood)
	
	mc.setBlocks(x+2,y+5,z+7,x,y,z,dsslab)#ring
	mc.setBlocks(x+2,y+5,z+4,x,y,z,sbrick)
	mc.setBlocks(x+2,y+5,z+3,x,y,z,dsslab)
	mc.setBlocks(x+2,y+5,z+7,x+5,y,z,dsslab)
	mc.setBlocks(x+3,y+5,z+6,x+4,y,z,air)
	mc.setBlocks(x+5,y+5,z+7,x,y,z,dsslab)
	mc.setBlocks(x+5,y+5,z+6,x,y,z,dbslab)
	mc.setBlocks(x+5,y+5,z+5,x,y,z,dsslab)
	mc.setBlocks(x+5,y+5,z+2,x,y,z,dbslab)
	mc.setBlocks(x+5,y+5,z,x,y,z,dsslab)
	mc.setBlocks(x+1,y+6,z+7,x,y,z,wood)#lid
	mc.setBlocks(x+1,y+6,z+6,x,y,z,woodp)
	mc.setBlocks(x+1,y+6,z,x,y,z,wood)
	mc.setBlocks(x+2,y+6,z+7,x+4,y,z,woodp)
	mc.setBlocks(x+5,y+6,z+7,x,y,z,wood)
	mc.setBlocks(x+5,y+6,z+6,x,y,z,woodp)
	mc.setBlocks(x+5,y+6,z,x,y,z,wood)
	mc.setBlocks(x+2,y+7,z+7,x+4,y,z,wood)
	mc.setBlocks(x+2,y+7,z+6,x+4,y,z,woodp)
	mc.setBlocks(x+2,y+7,z,x+4,y,z,wood)
