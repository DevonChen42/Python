...
def bin_dec(b): #b is a binary string
    ...
    i = 0 #i is the index of b strings
...
"""
This python code takes a CIDR input, converts it to binary, then separates the
bits into four binary octets. The octets from binary to decimal
